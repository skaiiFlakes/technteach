const data = {
  url: 'your-url-here',
  slug: 'Maple Syrup Weekend',
  headline: "'Pure gold': Indiana Maple Syrup Weekend comes to Bloomington",
  title: 'Maple Syrup Weekend',
  ...
  bylines: {
    By: {
      ...
      //   twitter: 'catcharron',
      pfp: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjGBBWtwUTDQ3wT6G9Dw397qbTi0BcYqYyug&s',
...
// bylines
const byline_types = ['By', 'Design & Development by', 'Design by'];
let bylines_html = '';
let bios_html = '';
